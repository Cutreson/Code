...
"color: rgb(255, 0, 0);")
        ...
        self.btn_delete_3 = QtWidgets.QPushButton(self.tab)
        self.btn_delete_3.setGeometry(QtCore.QRect(700, 480, 131, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_delete_3.setFont(font)
        self.btn_delete_3.setStyleSheet("background-color: rgb(170, 255, 255);\n"
"border-color: rgb(255, 0, 0);")
...
"border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_delete_3.setText(_translate("MainWindow", "Xóa dữ liệu"))
